...
public class PaymentList {
    ...
    /**Constructor initializes the empty payment list and sets the maximum list size
     ...
     * @param positionIn:The logical position of the payment in the list or null
     *                   if no payment at that logical position
     */
     ...
     * @return Returns the total values of payments recorded
     */
